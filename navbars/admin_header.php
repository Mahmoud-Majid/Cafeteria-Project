...
<div class="container-fluid px-0">
    ...
    <nav class="navbar navbar-expand-sm navbar-warning navbar-fixed-top bg-black py-0 px-0"> <a class="navbar-brand" id="logo" href="#">Java Cafe &nbsp;&nbsp;&nbsp;</a> <span class="v-line"></span> <button class="navbar-toggler mr-3" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active"> <a class="nav-link" href="#">Home</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">Products</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">Users</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">Manual Orders</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">Checks</a> </li>
                <li class="nav-item right"><img src="../images/admin.png" alt="admin" class="avatar"/></li>
                <li class="nav-item right"><a class="nav-link" href="../logout.php">Logout</a></li>
            </ul>
        </div>
    </nav>
</div>

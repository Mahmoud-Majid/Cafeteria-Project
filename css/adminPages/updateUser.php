    ...
    <div id="main-container">
        <div id="card">
            ...
            <div id="form-container">
                <table>
                    <form action="addUsermysqli.php" method="POST" id="form" enctype="multipart/form-data">
                        <tr>
                            <td><label>User Name</label></td>
                            <td><input class="input" type="text" name="username"
                                    value="<?php echo $data_arr[1];?>"" pattern=" [a-zA-Z_]+[a-zA-Z0-9]{2,10}"
                                    title="Name should start with letter or underscore, 3 characters at least 'No special characters are allowed'"
                                    required></td>
                        </tr>
                        <tr>
                            <td><label>Email</label></td>
                            <td><input class="input" type="email" name="email" value="<?php echo $data_arr[2];?>"
                                    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required></td>
                        </tr>
                        <tr>
                            <td><label>Password</label></td>
                            <td><input class="input" type="password" name="password" pattern="[a-zA-Z0-9._%+-]{3,}"
                                    title="password should not be less than 3 characters or contain a special character"
                                    required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="input" type="text" name="room" value="<?php echo $data_arr[3];?>"
                                    pattern="[0-9]{0,5}"></td>
                        </tr>
                        <tr>
                            <td><label>Ext.</label></td>
                            <td><input class="input" type="tel" name="ext" value="<?php echo $data_arr[4];?>"
                                    pattern="01[0-9]{9}"></td>
                        </tr>
                        <tr>
